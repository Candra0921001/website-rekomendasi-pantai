            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active text-info" href="alternatif.php">Alternatif</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    include "koneksi.php";
                    $sql = mysqli_query($koneksi, "select * from alternatif where id_alternatif='$_GET[id_alternatif]'");
                    $data = mysqli_fetch_array($sql);
                    ?>

                    <h1 class="h3 mb-2 text-gray-800">Form Ubah Alternatif</h1>
                    <form method="POST" action="aksi_saw_ubah.php">
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">ID Alternatif</label>
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="alternatif_saw" name="id_alt" value = "<?php echo $data['id_alternatif']?>" placeholder="Masukkan ID..." aria-describedby="validationServer03Feedback" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="alternatif_saw" name="nm_alternatif" value = "<?php echo $data['nama_alternatif']?>" placeholder="Masukkan Alternatif..." aria-describedby="validationServer03Feedback" required>
                            </div>
                        </div>

                        <a href="alternatif.php" class="btn btn-danger">Cancel</a>

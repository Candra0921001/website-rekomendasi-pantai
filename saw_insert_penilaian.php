        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Tambah Penilaian</h1>

                    <form method="POST" action="aksi_saw_insert.php">
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">ID Penilaian</label>
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="penilaian_saw" name="id_penilaian" placeholder="Masukkan ID..." aria-describedby="validationServer03Feedback" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <select class="form-control" id="exampleFormControlSelect1" name="value_bobot">
                                    <?php
                                    include 'koneksi.php';
                                    $sql = "SELECT * FROM bobot, kriteria where bobot.id_kriteria=kriteria.id_kriteria";
                                    $b = $koneksi->query($sql);
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <select class="form-control" id="exampleFormControlSelect1" name="nm_lokasi">
                                    <?php
                                    include 'koneksi.php';
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="bobot_saw" name="penilaian" placeholder="Masukkan Nilai..." aria-describedby="validationServer03Feedback" required>
                            </div>
                        </div>

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Data Alternatif</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="saw_insert_alternatif.php" class="btn btn-info">Tambah Data</a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        while ($tampil = mysqli_fetch_array($alternatif)) {
                                        ?>
                                            <tr>
                                                <th><?php echo $no++; ?></th>
                                                <th><?php echo $tampil['id_alternatif']; ?></th>
                                                <th><?php echo $tampil['nama_alternatif']; ?></th>
                                                <th>
                                                    <a href='saw_ubah_alternatif.php?id_alternatif=<?php echo $tampil["id_alternatif"] ?>' class="btn btn-dark">Edit</a>
                                                    <a href='aksi_saw_delete.php?delete=<?php echo $tampil["id_alternatif"] ?>' class="btn btn-danger" onclick="return confirm('Apakah Ingin Menghapus Data Ini?')">Hapus</a>
                                                </th>
                                            </tr>
                                        <?php
                                        }

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    include "koneksi.php";
                    $sql = mysqli_query($koneksi, "select * from bobot, kriteria where bobot.id_kriteria=kriteria.id_kriteria and id_bobot='$_GET[id_bobot]'");
                    $data = mysqli_fetch_array($sql);
                    ?>

                    <h1 class="h3 mb-2 text-gray-800">Form Ubah Bobot (ROC)</h1>
                    ...
                    <form method="POST" action="aksi_saw_ubah.php">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="bobot_saw" name="id_bobot" value = "<?php echo $data['id_bobot']?>" placeholder="Masukkan ID..." aria-describedby="validationServer03Feedback" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <select class="form-control" id="exampleFormControlSelect1" name="nm_kriteria" readonly>
                                    <?php
                                    include 'koneksi.php';
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-form-label">:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="bobot_saw" name="value_bobot" value = "<?php echo $data['value_bobot']?>" placeholder="Masukkan Nilai Bobot..." aria-describedby="validationServer03Feedback" required>
                            </div>
                        </div>


                        <a href="bobot.php" class="btn btn-danger">Cancel</a>

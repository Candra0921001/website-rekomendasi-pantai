                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-5">
                                            ...
                                            <form action="aksi_login.php?op=in" method="POST" class="user">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" id="exampleInputUsername" name="username" placeholder="Masukkan Username">
                                                </div>
                                                <div class="form-group">

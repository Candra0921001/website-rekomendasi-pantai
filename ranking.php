            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active text-info" href="ranking.php">Ranking</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <center>
                        <h6 class="m-0 h1 mb-2 font-weight-bold text-info">Ranking Pantai</h6>
                    </center>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        include "koneksi.php";
                                        $ranking  = mysqli_query($koneksi, "SELECT multimoora_3.id_alternatif,multimoora_3.nama_alternatif,SUM(multimoora_3.normalisasibobot) 
                                        AS hasil FROM multimoora_3 GROUP BY multimoora_3.id_alternatif ");
                                        while ($tampil = mysqli_fetch_array($ranking)) {
                                        ?>
                                            <tr>
                                                <th><?php echo $no++; ?></th>

            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active text-info" href="matrix_keputusan.php">Matrix Keputusan</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <center>
                        <h6 class="m-0 h1 mb-2 font-weight-bold text-info">Matrix Keputusan</h6>
                    </center>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        include "koneksi.php";
                                        $matrixkeputusan  = mysqli_query($koneksi, "SELECT matrix_penilaian.id_penilaian, alternatif.*, kriteria.*, bobot.id_bobot, bobot.value_bobot, matrix_penilaian.value_penilaian AS nilai
                                        ...
                                        while ($tampil = mysqli_fetch_array($matrixkeputusan)) {
                                        ?>
                                            <tr>
                                                <th><?php echo $no++; ?></th>

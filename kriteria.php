        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Data Kriteria</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="saw_insert_kriteria.php" class="btn btn-info">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php echo $no++; ?></th>
                                                <th><?php echo $tampil['id_kriteria']; ?></th>
                                                <th><?php echo $tampil['nama_kriteria']; ?></th>
                                                <th>
                                                    <a href='saw_ubah_kriteria.php?id_kriteria=<?php echo $tampil["id_kriteria"] ?>' class="btn btn-dark">Edit</a>
                                                    <a href='aksi_saw_delete.php?delete1=<?php echo $tampil["id_kriteria"] ?>' class="btn btn-danger" onclick="return confirm('Apakah Ingin Menghapus Data Ini?')">Hapus</a>
                                                </th>
                                            </tr>
                                        <?php
                                        }
